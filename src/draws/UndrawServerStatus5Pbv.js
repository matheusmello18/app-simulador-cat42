...
function SvgUndrawServerStatus5Pbv(props) {
  return (
    <svg
      data-name="Layer 1"
    ...
    >
      <defs>
        <linearGradient
          id="undraw_server_status_5pbv_svg__a"
          x1={1958.6}
          y1={638.33}
          x2={1958.6}
          y2={355.69}
      ...
      <path
        ...
        fill="url(#undraw_server_status_5pbv_svg__a)"
      />
      <path
      ...
      <circle
        ...
        opacity={0.1}
      />
      <circle cx={16} cy={106.18} r={16} fill="currentColor" opacity={0.1} />
      <circle cx={178} cy={16.18} r={16} fill="currentColor" opacity={0.1} />
      <circle cx={834} cy={18.18} r={16} fill="currentColor" opacity={0.1} />
      <path
...
export default SvgUndrawServerStatus5Pbv;
